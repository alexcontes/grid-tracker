...
return [
    ...
    'API_VERSION'         => '1.1',
    'AUTHENTICATE_URL'    => 'https://api.twitter.com/2/oauth/authenticate',
    'AUTHORIZE_URL'       => 'https://api.twitter.com/2/oauth/authorize',
    'ACCESS_TOKEN_URL'    => 'https://api.twitter.com/2/oauth/access_token',
    'REQUEST_TOKEN_URL'   => 'https://api.twitter.com/2/oauth/request_token',
    'USE_SSL'             => true,
